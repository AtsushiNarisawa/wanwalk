          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                ...
                '7. 匿名かつ統計的に加工した歩行データ（散歩ルート・距離・エリア別の傾向等）の分析、レポート・白書等の作成、および第三者への提供\n'
                '8. その他、上記に付随する目的',
              ),
              ...
              _buildSection(
                ...
                '上記のほか、当方は、ユーザーの散歩記録・位置情報を含む歩行データを匿名かつ統計的に加工した情報（特定の個人を識別できないよう集計・加工したもの）を、自治体・観光地域づくり法人（DMO）・民間事業者を含む第三者に対し、地域の犬連れ観光・散歩環境に関する分析、レポート、白書その他の目的で提供することがあります。この場合においても、当方は、特定の個人を識別できる位置履歴（個々のユーザーの移動軌跡そのもの）を第三者に提供することはありません。',
              ),
              ...
              _buildSection(
                '14. 改訂履歴',
                '• 2026年7月22日: 投稿プログラム開始に伴う改訂（匿名・統計加工した歩行データの分析・レポート作成・第三者提供を利用目的に明記）\n'

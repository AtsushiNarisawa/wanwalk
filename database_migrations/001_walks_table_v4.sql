...
-- Created: 2025-11-23
-- Version: 4 (修正版 - routes.area_id → routes.area に修正)
-- ============================================================================
--
-- 設計方針:
...
--
-- 修正内容 (v3 → v4):
-- - calculate_walk_statistics: r.area_id → r.area に変更
-- - get_outing_walk_history: areas テーブルとの結合を削除
--   (routes.area は TEXT 型で公園名など、areas.name は市区町村レベルで粒度が異なるため)
-- ============================================================================
...
-- 修正: areas テーブルとの結合を削除 (routes.area は TEXT 型の場所名)
...
BEGIN
  ...
  SELECT 
    ...
    r.area AS route_area,          -- TEXT型の場所名（例: 駒沢オリンピック公園）
...
BEGIN
  ...
  SELECT 
    ...
    -- 修正: r.area_id → r.area (TEXT型のユニークな場所名をカウント)
...
-- ============================================================================
-- End of Migration: 001_walks_table_v4.sql
-- ============================================================================

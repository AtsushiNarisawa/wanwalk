...
-- バッジシステム修正SQL（安全版）
-- ============================================================
-- 戦略: 既存のテーブルを壊さず、不足している部分だけを追加
--
-- 現状:
--   ✓ badge_definitions テーブル存在（古い構造）
--   ✓ user_badges テーブル存在
--   ✗ badges ビュー不足
--   ✗ get_user_badges 関数が正しく動作していない可能性
-- ============================================================
...
-- ========================================
-- ステップ2: get_user_badges 関数を作成/更新
-- ========================================
...
-- ========================================
-- ステップ3: mark_badges_as_seen 関数を作成/更新
-- ========================================

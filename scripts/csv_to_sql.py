...
# エリア名→area_id変換マップ
# 注意: 箱根は親エリア + 5つのサブエリアに分割されています
AREA_MAP = {
    # 箱根エリア（親エリア + サブエリア）
    '箱根': 'a1111111-1111-1111-1111-111111111111',  # 親エリア（使用非推奨）
    '箱根・湯本塔ノ沢': 'b1111111-1111-1111-1111-111111111111',  # 箱根湯本・塔ノ沢
    '箱根・宮ノ下小涌谷': 'b2222222-2222-2222-2222-222222222222',  # 宮ノ下・小涌谷
    '箱根・強羅早雲山': 'b3333333-3333-3333-3333-333333333333',  # 強羅・早雲山
    '箱根・仙石原大涌谷': 'b4444444-4444-4444-4444-444444444444',  # 仙石原・大涌谷（DogHub）
    '箱根・芦ノ湖元箱根': 'b5555555-5555-5555-5555-555555555555',  # 芦ノ湖・元箱根
    
    # その他のエリア
    '横浜': 'a2222222-2222-2222-2222-222222222222',
    '鎌倉': 'a3333333-3333-3333-3333-333333333333',
    
    # 以下のエリアIDは要確認（実際のデータベースで確認してください）
    # '伊豆': 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
    # '那須': 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
    # '軽井沢': 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
    # '富士山周辺': 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
}

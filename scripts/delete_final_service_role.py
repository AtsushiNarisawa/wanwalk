...
SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImprcGVua2xocmxiY3RlYmtwdmF4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MjkyNzAwNSwiZXhwIjoyMDc4NTAzMDA1fQ.koP83Cgyvktyg3Oge7oE_nGQcOD5mj6xOvYuxvFvJWU"

# Routes to KEEP (22 routes)
KEEP_ROUTES = {
    ...
    "7013fa14-d8d5-454a-9f71-81e528cad318",  # お台場
...
print(f"Current total: {len(all_routes)} routes")
...
for route in all_routes:
    ...
    if route_id in KEEP_ROUTES:
        ...
        if delete_response.status_code in [200, 204]:
            deleted += 1
            if deleted % 10 == 0:
                print(f"削除済み: {deleted}ルート")
        else:
            print(f"エラー: {route_id} - {delete_response.status_code}")

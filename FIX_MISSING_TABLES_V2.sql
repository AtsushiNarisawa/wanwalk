-- =====================================================
-- 欠落テーブルの修正 V2 - WanMap データベース同期
-- =====================================================
-- route_favoritesは official_routes を参照しているため除外
-- データ移行はフィールド互換性を確認後に実行
-- =====================================================
...
-- route_likesテーブルが存在し、routesテーブルを参照している場合のみコピー
-- 現時点ではスキップ（後でテストデータを挿入）

-- =====================================================
-- 6. favorites テーブル（お気に入り機能）
-- 注意: route_favoritesは official_routes を参照
-- 新しいfavoritesは routes（ユーザー作成ルート）を参照
-- =====================================================
...
-- route_favoritesは official_routes を参照しているため、
-- データ移行はスキップ（後でテストデータを挿入）
